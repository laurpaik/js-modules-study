...
let list = (function(listItem){
  let a = [];
  const makeAList = function () {
    return a.push(listItem);
  };
  return makeAList;
});
module.exports = {
...
// what is 'value' here? not fully getting it since in the past we didn't
// need to do a key value pair or anything in module.exports
